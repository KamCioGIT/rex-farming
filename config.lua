...
Config.FarmShop = {
     ...
     [4] = { name = 'tomatoseed',    price = 0.10, amount = 500,  info = {}, type = 'item', slot = 4, },
     [5] = { name = 'broccoliseed',  price = 0.10, amount = 500,  info = {}, type = 'item', slot = 5, },
     [6] = { name = 'potatoseed',    price = 0.10, amount = 500,  info = {}, type = 'item', slot = 6, },
     [7] = { name = 'artichokeseed', price = 0.10, amount = 500,  info = {}, type = 'item', slot = 7, },
